                    ...
                    <table>
                        <tbody>
                            ...
                            <tr>
                                <td colSpan={3}>
                                    <div>
                                        <input type="text" placeholder="Nombre de la materia" name="nombreMateria" />
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td colSpan={3}>
                                    <div>
                                        <input type="search" name="docente" placeholder="Docente" style={{ float: "left" }} />
                                        <button className="button-2" role="button" value="Buscar" style={{ float: "left" }}>Buscar</button>
                            ...
                            <tr>
                                <td colSpan={3}>
                                    <div className="caja" style={{ float: "left", width: "31%" }}>
                                        <select name="curso">
                                            <option value="curso">Curso</option>
                                            <option value="curso">1ro</option>
                                            <option value="curso">2do</option>
                                            <option value="curso">3ro</option>
                                            <option value="curso">4to</option>
                                            <option value="curso">5to</option>
                                            <option value="curso">6to</option>
                                            <option value="curso">7mo</option>
                                        </select>
                                    </div>
                                    <div className="caja" style={{ float: "left", width: "31%" }}>
                                        <select name="division">
                                            <option value="division">Division</option>
                                            <option value="division">A</option>
                                            <option value="division">B</option>
                                            <option value="division">C</option>
                                            <option value="division">D</option>
                                            <option value="division">E</option>
                                            <option value="division">F</option>
                                        </select>
                                    </div>
                                    <div className="caja" style={{ float: "left", width: "31%" }}>
                                        <select name="turno">
                            ...
                            <tr>
                                <td colSpan={3}>
                                    ...
                                    <div style={{width: "100%"}}>
                                        <div className="caja" style={{ float: "left", width: "22%" }}>
                                            <select id="dia" style={{ float: "left" }} name="dia">
                                        ...
                                        <div className="caja" style={{ float: "left", width: "17%" }}>
                                            <select id="manianaDesde" style={{ float: "left" }} name="manianaDesde">
                                        ...
                                        <div className="caja" style={{ float: "left", width: "17%" }}>
                                            <select id="manianaHasta" style={{ float: "left" }} name="manianaHasta">
                                        ...
                                        <div className="caja" style={{ float: "left", width: "17%" }}>
                                            <select id="tardeDesde" style={{ float: "left" }} name="tardeDesde">
                                                <option value="">Desde:</option>
                                                <option value="00:00">00:00</option>
                                                <option value="00:05">00:05</option>
                                                <option value="00:10">00:10</option>
                                        ...
                                        <div className="caja" style={{ float: "left", width: "17%" }}>
                                            <select id="tardeHasta" style={{ float: "left" }} name="tardeHasta">
                                                <option value="">Hasta:</option>
                                                <option value="00:00">00:00</option>
                                                <option value="00:05">00:05</option>
                                                <option value="00:10">00:10</option>
                            ...
                            <tr>
                                <td colSpan={3}>
                                    <div className="submit">
                                        <input type="button" value="Agregar horario" style={{height: "25px", margin: "0 10px"}} />
                                    </div>
                                </td>
                            </tr>
                            <tr>
